    ...
    return (
        <div className='plant-card'>
            ...
            <div className='plant-card__header'>
                ...
                <button className="btn" onClick={() => props.push(`/plant/${props.plant.trefle_id}`)}>Details</button>
                    <button className="btn" onClick={() => handleDelete(props.plant.instance_id)}>Delete</button>
            </div>
            ...
            <label htmlFor={`plant-card__note__${props.idx}`} className="hidden">Plant Notes</label>
            <textarea
